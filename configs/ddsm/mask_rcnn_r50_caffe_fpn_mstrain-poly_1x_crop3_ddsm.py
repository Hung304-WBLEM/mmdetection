...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=[(1733, 832), (1733, 874), (1733, 915), (1733, 883),
                   (1733, 922), (1733, 960)],
        multiscale_mode='value',
        keep_ratio=True),
    dict(type='RandomCrop', crop_size=(10/13, 10/13), crop_type='relative'),
...
work_dir = '/home/hqvo2/Projects/Breast_Cancer/experiments/mmdet_processed_data/mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_crop3_ddsm'
