...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=[(1466, 704), (1466, 739), (1466, 774), (1466, 810),
                   (1466, 845), (1466, 880)],
        multiscale_mode='value',
        keep_ratio=True),
    dict(type='RandomCrop', crop_size=(0.1, 0.1), crop_type='relative'),
...
work_dir = '/home/hqvo2/Projects/Breast_Cancer/experiments/mmdet_processed_data/mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_crop_ddsm'
