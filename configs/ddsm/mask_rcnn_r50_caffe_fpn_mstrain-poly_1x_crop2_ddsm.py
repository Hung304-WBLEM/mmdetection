...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=[(1600, 768), (1600, 806), (1600, 845), (1600, 883),
                   (1600, 922), (1600, 960)],
        multiscale_mode='value',
        keep_ratio=True),
    dict(type='RandomCrop', crop_size=(10/12, 10/12), crop_type='relative'),
...
work_dir = '/home/hqvo2/Projects/Breast_Cancer/experiments/mmdet_processed_data/mask_rcnn_r50_caffe_fpn_mstrain-poly_1x_crop2_ddsm'
